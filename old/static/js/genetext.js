...
/***/ function(module, exports, __webpack_require__) {
	...
	function listen() {
	  document.getElementById('genetext').addEventListener('click', function () {
	    if (isRunning) return;
	    play();
	  });
	}
	...
	function play() {
	  var genetext = document.getElementById('genetext');
    //   modify
	  var history = (0, _gen2.default)('Get everything you need :)').history;
	  isRunning = true;
	  var i = 0;
	  history.forEach(function (text, i) {
	    setTimeout(function () {
			genetext.innerText = text;
